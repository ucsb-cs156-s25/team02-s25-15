...
public class MenuItemReviewIT {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                Long id = menuitemreview1.getId();

                // act
                MvcResult response = mockMvc.perform(get("/api/MenuItemReviews?id=" + id))
        ...
        public void an_admin_user_can_post_a_new_menuItemReview() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/MenuItemReviews/post?itemId=1&reviewerEmail=tyler_wong@ucsb.edu&stars=4&dateReviewed=2022-01-03T00:00:00&comments=Quite good.")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
