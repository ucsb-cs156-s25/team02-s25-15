const articlesFixtures = {
  ...
  threeArticles: [
    ...
    {
      id: 3,
      title: "Taco Bell Brings Back Fan-Favorite Chicken Nuggets",
      url: "https://www.tacobell.com/newsroom/crispy-chicken-nuggets-return",
      explanation:
        "Following a sell-out launch and overwhelming fan demand, Crispy Chicken Nuggets return to menus on April 24 as one delicious way Taco Bell is exploring its long-term crispy chicken menu",
      email: "tacobell@ucsb.edu",
      dateAdded: "2025-04-17T12:12:12",
    },
  ],
};
